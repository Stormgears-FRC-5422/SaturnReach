...
//
//public class StormSpark extends SparkMax {
//  private static final double temperatureRampThreshold = SparkConstants.TemperatureRampThreshold;
//  private static final double temperatureRampLimit = SparkConstants.TemperatureRampLimit;
...
//
//  public StormSpark(int deviceID, SparkLowLevel.MotorType type, MotorKind kind) {
//    super(deviceID, type);
//
//    this.motorKind = kind;
//
//    switch (motorKind) {
//      case kNeo:
//        currentLimit = (int) SparkConstants.CurrentLimit;
//        break;
//      case k550:
//        currentLimit = (int) SparkConstants.Neo550CurrentLimit;
//        break;
//    }
//
