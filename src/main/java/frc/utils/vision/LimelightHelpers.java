...
//
// Official Source: https://github.com/LimelightVision/limelightlib-wpijava
// Documentation:   https://docs.limelightvision.io/docs/docs-limelight/apis/limelight-lib
//
// Package modified from frc.robot to frc.utils.vision for project organization.
 ...
 * This library supports all Limelight features including AprilTag tracking, Neural Networks,
...
public class LimelightHelpers {
    ...
    /**
     * Represents a Limelight Raw Fiducial result from NetworkTables output.
     */
    ...
    /**
     * Represents a Limelight Raw Neural Detector result from NetworkTables output.
     */
    ...
    /**
     * Converts a 6-length array to Pose3d. Format: [x, y, z, roll, pitch, yaw] (degrees)
     */
    ...
    /**
     * Converts a 6-length array to Pose2d. Uses x, y, yaw only.
     */
    ...
    public static RawDetection[] getRawDetections(String limelightName) {
        ...
        for (int i = 0; i < numDetections; i++) {
            ...
            rawDetections[i] = new RawDetection(classId, txnc, tync, ta,
    ...
    /** Horizontal offset from principal pixel (no crosshair) */
    public static double getTXNC(String limelightName) {
        return getLimelightNTDouble(limelightName, "txnc");
    }

    /** Vertical offset from principal pixel (no crosshair) */
    ...
    /**
     * Gets the latest JSON results and returns a LimelightResults object.
     * Note: JSON parsing can take up to 2ms on RoboRIO - use raw methods for performance.
     */
